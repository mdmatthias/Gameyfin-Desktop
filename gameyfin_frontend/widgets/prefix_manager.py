...
class PrefixItemWidget(QWidget):
    ...
    def create_desktop_shortcuts(self, all_desktop_files: list, selected_desktop: list, selected_apps: list):
        ...
        # We gebruiken de prefix_path om de game_name te bepalen en dan de juiste scripts_dir
        ...
        home_dir = os.path.expanduser("~")
        os.makedirs(self.primary_scripts_dir, exist_ok=True)
            ...
            try:
                ...
                if umu_run_line:
                    ...
                    if len(parts) > 1:
                        ...
                        # Reconstruct command
                        new_command = f"{env_part}{umu_command} {exe_args}"
