    ...
    def create_desktop_shortcuts(self, all_desktop_files: list, selected_desktop: list, selected_apps: list):
        ...
        for original_path in all_desktop_files:
            try:
                ...
                env_prefix = build_umu_env_prefix(proton_path, self.current_wine_prefix, config)
            ...
            for original_path in selected_list:
                try:
                    ...
                    if icon_name:
                        ...
                        found_icon_path = copy_icon_from_source(shortcuts_dir, icon_name)

                        if found_icon_path:
                            config_parser.set('Desktop Entry', 'Icon', found_icon_path)
                        else:
                            print(f"Warning: Could not find icon '{icon_name}' in {shortcuts_dir}")
